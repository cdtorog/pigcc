 ...
 */
export declare type PropertyValue = string | number | boolean | null;
/**
 ...
 */
export declare type StrMatchesFunctionOperator = 'FN_strMatches';
/**
 * All operators.
 */
export declare type Operator = ComparisonOperator | CombinationOperator | NegationOperator | StrMatchesFunctionOperator;
/**
 ...
 */
export declare type StrMatchesFunctionFilter = [
 ...
 */
export declare type FunctionFilter = StrMatchesFunctionFilter;
/**
...
export declare type Filter = FunctionFilter | ComparisonFilter | NegationFilter | CombinationFilter;
/**
